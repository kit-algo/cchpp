...
\setlength{\tabcolsep}{5pt}
\caption{
Running times and parallelization effectiveness of different steps of the customization phase on Stuttgart and Europe in comparison with the baseline results reported in~\cite{DibbeltSW16} and the improvements proposed in~\cite{BuchholdSW19}.
...
\caption{
Average running times of incremental Lazy RPHAST on CH and CCH while querying $|S| = 2^{14}$ from a ball of varying size $|B|$ on Germany excluding selection times.

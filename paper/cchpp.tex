...
\toprule
{}       &                     & \multicolumn{3}{c}{Travel time}                                        & \multicolumn{3}{c}{Distance}                  \\
                                 \cmidrule(lr){3-5}                                                       \cmidrule(lr){6-8}
{}       &                     &             Prepro.  &            Custom. &          Queries & Prepro. & Custom. &   Queries \\
{}       &                     &                 [s]  &                [s] &             [ms] &     [s] &     [s] &      [ms] \\
\midrule
Dijkstra &                     &                    - &                  - &        1\,061.52 &       - &       - &  2\,674.72 \\
CH       & \cite{DellingGPW17} &                  109 &                  - &             0.11 &  1\,392 &       - &       0.87 \\
CRP      & \cite{DellingGPW17} &                  654 &               1.05 &             1.65 &     654 &    1.04 &       1.91 \\
CCH      &                     &                  367 &               1.25 &             0.14 &     367 &    1.25 &       0.18 \\
\bottomrule
\end{tabular}
\end{table}

...
\KwData{$\mathtt{T}[v]$: parent node of $v$ in the elimination tree, parent of root is $\bot$}
...
Important feature bla. % TODO
In~\cite{TODO}, an efficient $k$-nearest-neighbor query algorithms for CCH was introduced.
It heavily utilizes the separator decomposition of the network.

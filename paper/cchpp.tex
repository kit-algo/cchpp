...
Usually, the amount of unnecessarily vertices visited by the elimination tree variant is very small in comparison to the total work and is thus more than compensated by the more efficient implementation.

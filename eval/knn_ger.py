...
plot = sns.lineplot(data=queries.query('num_targets_to_find == 4 & graph == "Germany"'), x='target_set_size_exp', y='running_time_ms', hue='family', style='phase', dashes={'select': '', 'query': ''}, markers={'select': 'o', 'query': 'X'}, ci=None, legend=None)
plot.set_yscale('log')
...
fig.tight_layout()
fig.savefig('paper/fig/knn_ger.pdf')

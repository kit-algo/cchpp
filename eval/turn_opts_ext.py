...
topo_prepros_table = topo_prepros.query('hostname == "compute4"').groupby(['graph', 'variant'])['total_preprocessing_ms'].mean()
...
output = output.replace('Chicago', r'\multirow{7}{*}{\rotatebox[origin=c]{90}{Chicago}}')
output = output.replace('London', r'\addlinespace \multirow{7}{*}{\rotatebox[origin=c]{90}{London}}')
